    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            if not voter:
                ...
                if 'sias' in email and 'krea.ac.in' in email:
...
if __name__ == "__main__":
    ...
    excel_file_path = '/Users/aaravshaurya/Documents/SIAS/Y3-T7/COMP350/project/SIAS22-25Data.xlsx'  # Update with your actual file path
